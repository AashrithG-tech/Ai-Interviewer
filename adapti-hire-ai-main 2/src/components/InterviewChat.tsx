...
import { getEncouragingResponse } from "@/lib/interviewQuestions";
    ...
    const startInterview = async () => {
      ...
      try {
        ...
        const firstQuestion: Message = {
          id: "q0",
          role: "assistant",
          content: data.question || "Tell me about yourself and what brings you to this interview today.",
          timestamp: new Date(),
        };
        ...
        const firstQuestion: Message = {
          id: "q0",
          role: "assistant",
          content: "Tell me about yourself and what brings you to this interview today.",
          timestamp: new Date(),
        };
        setMessages([welcomeMessage, firstQuestion]);
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(async () => {
      ...
      if (nextQuestionIndex < MAX_QUESTIONS) {
        ...
        try {
          const conversationForAI = [...messages, userMessage, ...responses];
          ...
          const nextQuestionMsg: Message = {
            ...
            role: "assistant",
            content: data.question || "Could you tell me more about your experience?",
            timestamp: new Date(),
          };
          ...
          const nextQuestionMsg: Message = {
            id: `q${nextQuestionIndex}`,
            role: "assistant",
            content: "Could you tell me more about your experience?",
            timestamp: new Date(),
          };
          responses.push(nextQuestionMsg);
          setCurrentQuestion(nextQuestionIndex);
